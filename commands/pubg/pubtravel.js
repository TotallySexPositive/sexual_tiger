...
exports.run = (client, message, args) => {
	...
	message.channel.send(`Making travel plot.`);
...
function doit(client,message,args){
    ...
    var py_args = [script_path, "getTravelBoxPlot", "--path", db_path]
...
exports.help = () =>{
    return "Gives you a plot about how far you and your friends travel (walk+drive).";
};