...
exports.run = (client, message, args) => {
	...
	message.channel.send(`Making kills per match plot.`);
...
function doit(client,message,args){
    ...
    var py_args = [script_path, "getKillsStats", "--path", db_path]
...
exports.help = () =>{
    return "Gives you a cool plot of you and your friends' kills per match.";
};